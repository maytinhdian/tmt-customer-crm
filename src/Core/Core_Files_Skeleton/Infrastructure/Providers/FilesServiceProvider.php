...
final class FilesServiceProvider
{
    ...
    {
        Container::bind(FileRepositoryInterface::class, fn() => new WpdbFileRepository($GLOBALS['wpdb']));
        Container::bind(StorageInterface::class, fn() => new WpUploadsStorage());
        Container::bind(FileService::class, fn() => new FileService(
