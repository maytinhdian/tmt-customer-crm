...
use TMT\CRM\Application\DTO\Company_DTO;
use TMT\CRM\Domain\Entities\Company;
use TMT\CRM\Domain\Repositories\Company_Repository_Interface as Repo;
...
final class Company_Service
{
    ...
    public function create(Company_DTO $d): int
    {
        $e = new Company(
            id: null,
            name: $d->name,
    ...
    public function update(int $id, Company_DTO $d): bool
    {
