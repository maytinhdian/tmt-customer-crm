...
use TMT\CRM\Domain\Repositories\Quotation_Repository_Interface;

final class Quotation_Service {
    const STATUS_DRAFT    = 'draft';
    const STATUS_SENT     = 'sent';
    const STATUS_ACCEPTED = 'accepted';
    const STATUS_REJECTED = 'rejected';

    public function __construct(private Quotation_Repository_Interface $repo) {}
