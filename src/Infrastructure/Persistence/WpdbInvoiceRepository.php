...
use wpdb; use TMT\CRM\Domain\Entities\Invoice; use TMT\CRM\Domain\Repositories\InvoiceRepositoryInterface;

final class WpdbInvoiceRepository implements InvoiceRepositoryInterface {
